  ...
  <div class="left-panel q-pa-md">
    <div class="row items-center justify-between q-mb-md">
      ...
      <q-btn
        ...
        "
      >
        <q-btn class="q-mt-sm" :no-caps="true" color="primary" dense>
          <span v-if="props.selectionMode==='day'"> {{ t('calendarPicker.badgeRange') }}</span>
          <span v-else> {{ t('calendarPicker.badgeDay') }}</span>
        </q-btn>
      </q-btn>
    </div>
